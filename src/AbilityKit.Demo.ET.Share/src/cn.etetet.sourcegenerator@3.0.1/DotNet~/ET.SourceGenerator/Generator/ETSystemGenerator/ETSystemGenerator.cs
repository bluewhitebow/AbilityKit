                                              ...
                                              Dictionary<string, StringBuilder> builders)
    {
        ...
        foreach (MethodDeclarationSyntax? methodDeclarationSyntax in methodDeclarationSyntaxes)
        {
            ...
            foreach (AttributeListSyntax attributeListSyntax in methodDeclarationSyntax.AttributeLists)
            {
                ...
                // fullArgsTypes 使用完整的 global:: 前缀形式
                string fullArgsTypes = string.Join(", ", methodSymbol.Parameters.Select(p =>
                ...
                code = code.Replace("$fullArgsTypes$", fullArgsTypes);
